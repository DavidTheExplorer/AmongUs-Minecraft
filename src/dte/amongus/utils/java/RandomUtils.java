...
public class RandomUtils
{
	...
	public static class CollectionHelper<E>
	{
		...
		{
			return RandomUtils.findElementThat(this.collection, tester);
		}
	}
	...
	public static class MapHelper<K, V>
	{
		...
		{
			return RandomUtils.findElementThat(this.map.keySet(), tester);
		}
		public V getValueThat(Predicate<V> tester) 
		{
			return RandomUtils.findElementThat(this.map.values(), tester);
		}
		public Entry<K, V> getEntryThat(Predicate<Entry<K, V>> tester)
		{
			return RandomUtils.findElementThat(this.map.entrySet(), tester);
		}
	}
}